...
{
	public abstract class WindowBase : MahApps.Metro.Controls.MetroWindow, INotifyPropertyChanged, ILockablePage
	{
		...
		public WindowBase()
		{
			...
			this.Initialized += this.PageBase_Initialized;
		}
		#region Eventhandler
		private void PageBase_Initialized( object sender, EventArgs e )
		{
