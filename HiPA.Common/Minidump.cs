...
namespace HiPA.Common
{
	public static class MiniDump
	{
		...
		public static bool Write( SafeHandle fileHandle, MiniDumpType options, ExceptionInfo exceptionInfo )
		{
		...
		{
			return Write( fileHandle, dumpType, ExceptionInfo.Present );
		}
		...
		public static bool Write( string fileName, MiniDumpType dumpType )
		{
			...
			{
				ret = Write( stream.SafeFileHandle, dumpType );
			}
			return ret;
		}
